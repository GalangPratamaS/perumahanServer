<?php
//untuk melihat progres beli dari sisi pelanggan, ProgresBeli
if($_SERVER['REQUEST_METHOD'] == 'POST'){

	$id = $_POST['no_transaksi'];
	$nama_plg = $_POST['nama_pelanggan'];

	$sql = "SELECT * FROM `tbl_pelanggan` INNER JOIN tbl_transaksi_rumah WHERE tbl_pelanggan.no_pelanggan = tbl_transaksi_rumah.no_pelanggan AND tbl_transaksi_rumah.no_transaksi = '$id' AND tbl_transaksi_rumah.nama_pelanggan LIKE'%$nama_plg%'";
